package com.dms.api.common.aspect;

import com.dms.api.common.annotation.SysLog;
import com.dms.api.common.utils.HttpContextUtils;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.dms.api.common.annotation.SysLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		try{
			...
			sysLog.setParams(new Gson().toJson(params));
		}catch (Exception e){
