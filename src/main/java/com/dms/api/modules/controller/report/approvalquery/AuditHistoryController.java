...
/**
 * @Author: hejiaxi
 * @CreateDate: 2018/9/7 11:24
 * @Description: 作用描述:历史申请记录
 */
@RestController
@RequestMapping("auditHistory")
public class AuditHistoryController extends AbstractController {
    ...
    @RequestMapping("/list")
    @RequiresPermissions("auditHistory:list")
    public R list(@RequestParam Map<String, String> params) {
        ...
        return auditHistoryService.queryList(params);
    }
}
